...
export default function PostLogin() {
    ...
    return (
        <div className='login-box grid-border' style={{width:"720px"}}> 
            <img src="/assets/background/region.png" style={{maxWidth:"50%", minWidth:"300px"}} className="img img-fluid mb-3"/>
            <h3 className='text-white'>Enrich your knowledge about Fauna, Start using <b style={{color:"var(--primaryColor)"}}>AnimalPedia</b></h3>
