        ...
        <li>
            {
                isLogged(
                    <>
                        <a className={"btn nav-link bg-danger text-white" + getActive(active,"login")} data-bs-toggle="modal" data-bs-target={"#signoutModal"}>
                    ...
                    ,
                    <a className={"btn nav-link bg-success text-white" +  getActive(active,"login")} href="/login">
